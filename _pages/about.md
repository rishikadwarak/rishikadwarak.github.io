...
<div style="display: flex; justify-content: space-between; padding: 2rem 0;">
 ...
 <div style="flex: 1;">
   <h2>Education</h2>
   <ul>
     <li>Masters in Information Systems Management - Business Intelligence & Data Analytics, 2024-2025<br>
     <em>Carnegie Mellon University, Pittsburgh, PA</em></li>
     <li>B.Tech in Computer Science and Engineering, 2018-2022<br>
     <em>Shiv Nadar University, India</em></li>
   </ul>
 </div>
</div>
...
<ul>
   <strong>August 2024</strong>: Began my Master's degree program at <a href="https://www.heinz.cmu.edu/programs/information-systems-management-master/bida">Carnegie Mellon University</a>.<br>
